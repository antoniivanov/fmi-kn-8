...
void read_all_combinations_for_n_bits(char results[1024000][6], int *result_size, int num) {
    int results_size = 0;  // set initial size
    int bits_list[10] = {1, 2, 4, 8, 1, 2, 4, 8, 16, 32};
    get_all_combinations(results, results_size, 0, 0, bits_list, 0, 10, num);
}

void print_results(char result[1024000][6], int size) {
